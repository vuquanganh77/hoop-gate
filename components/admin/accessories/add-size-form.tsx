...
import { addSize } from "@/model/products/accessories/accessories"
...
interface AddSizeFormProps {
    accessories: Accessories | undefined; // Biến chứa dữ liệu giày cần chỉnh sửa
    handleClose: () => void; // Hàm đóng form chỉnh sửa
}

const AddSizeForm: React.FC<AddSizeFormProps> = ({ accessories, handleClose }) => {
