        ...
        <>
            ...
            <Flex h={'60px'} flexDirection={"row"} px={'20px'} >
                ...
                <Box display={['none', 'none', 'flex', 'flex', 'flex']}>
                    <Category name={'home'} text={"Home"} link={'/'} />
                    <Category name={'/'} text={"DashBoard"} link={'/admin'} />
                    <Category name={'men'} text={"Manage Shoes"} link={'/admin/shoes'} />
                    <Category name={'women'} text={"Manage Clothes"} link={'/admin/clothes'} />
                    <Category name={'kids'} text={"Manage Accessories"} link={'/admin/accessories'} />
                    <Category name={'kids'} text={"Manage Orders"} link={'/admin/orders'} />
                    <Category name={'kids'} text={"Manage Accounts"} link={'/admin/accounts'} />
                </Box>
