...
export default function ShoesDetail() {
    ...
    const [mainImage, setMainImage] = useState(
        "https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/560b0651-c9f1-44b3-9415-e1e417a015fd/JA+2+PREHEAT+EP.png"
    );
        ...
        <div>
            <div className="flex gap-7  justify-center pb-32">
                ...
                <div className="flex flex-col gap-2 ">
                    ...
                    <Button className="bg-black text-white radius rounded-3xl p-3 hover:bg-white hover:text-black hover:border">Add to cart</Button>
                    <Button className="bg-white text-black border radius rounded-3xl p-3 hover:bg-black hover:text-white">Favorite<Heart /></Button>
