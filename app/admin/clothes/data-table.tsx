...
import { ClothesSizeDetail } from "@/app/admin/clothes/product-detail"
...
export function DataTable<TData, TValue>({
    ...
    const pagination = useTypedSelector((state) => ({
        pageIndex: state.clothes.page_index,
        pageSize: state.clothes.page_size,
    }))
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription asChild>
                            <ClothesSizeDetail product_id={selectedId} />
                        </DialogDescription>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
